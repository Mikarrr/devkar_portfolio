...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.run(sql`CREATE TABLE \`pages_blocks_hero_section_cta_buttons\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text,
  	\`href\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_hero_section\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_section_cta_buttons_order_idx\` ON \`pages_blocks_hero_section_cta_buttons\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_section_cta_buttons_parent_id_idx\` ON \`pages_blocks_hero_section_cta_buttons\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`pages_blocks_hero_section_background_image_idx\` ON \`pages_blocks_hero_section\` (\`background_image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_about_me_section_stats\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text,
  	\`value\` numeric,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`pages_blocks_about_me_section\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_about_me_section_stats_order_idx\` ON \`pages_blocks_about_me_section_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_about_me_section_stats_parent_id_idx\` ON \`pages_blocks_about_me_section_stats\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_about_me_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`tagline\` text DEFAULT 'O MNIE',
  	\`heading\` text,
  	\`description\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_about_me_section_order_idx\` ON \`pages_blocks_about_me_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_about_me_section_parent_id_idx\` ON \`pages_blocks_about_me_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_about_me_section_path_idx\` ON \`pages_blocks_about_me_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_about_me_section_profile_image_idx\` ON \`pages_blocks_about_me_section\` (\`profile_image_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_about_me_section_background_image_idx\` ON \`pages_blocks_about_me_section\` (\`background_image_id\`);`)
  await db.run(sql`CREATE TABLE \`pages_blocks_technology_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`tagline\` text DEFAULT 'TECHNOLOGIA',
  	\`heading\` text,
  	\`description\` text,
  	\`cta_button_label\` text,
  	\`cta_button_href\` text,
  ...
  `)
  await db.run(sql`CREATE INDEX \`pages_blocks_technology_section_order_idx\` ON \`pages_blocks_technology_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_technology_section_parent_id_idx\` ON \`pages_blocks_technology_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_technology_section_path_idx\` ON \`pages_blocks_technology_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`pages_blocks_technology_section_background_image_idx\` ON \`pages_blocks_technology_section\` (\`background_image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_hero_section_cta_buttons\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`label\` text,
  	\`href\` text,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_hero_section\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_section_cta_buttons_order_idx\` ON \`_pages_v_blocks_hero_section_cta_buttons\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_section_cta_buttons_parent_id_idx\` ON \`_pages_v_blocks_hero_section_cta_buttons\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_hero_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_section_order_idx\` ON \`_pages_v_blocks_hero_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_section_parent_id_idx\` ON \`_pages_v_blocks_hero_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_section_path_idx\` ON \`_pages_v_blocks_hero_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_hero_section_background_image_idx\` ON \`_pages_v_blocks_hero_section\` (\`background_image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_about_me_section_stats\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`label\` text,
  	\`value\` numeric,
  	\`_uuid\` text,
  	FOREIGN KEY (\`_parent_id\`) REFERENCES \`_pages_v_blocks_about_me_section\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_about_me_section_stats_order_idx\` ON \`_pages_v_blocks_about_me_section_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_about_me_section_stats_parent_id_idx\` ON \`_pages_v_blocks_about_me_section_stats\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_about_me_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_about_me_section_order_idx\` ON \`_pages_v_blocks_about_me_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_about_me_section_parent_id_idx\` ON \`_pages_v_blocks_about_me_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_about_me_section_path_idx\` ON \`_pages_v_blocks_about_me_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_about_me_section_profile_image_idx\` ON \`_pages_v_blocks_about_me_section\` (\`profile_image_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_about_me_section_background_image_idx\` ON \`_pages_v_blocks_about_me_section\` (\`background_image_id\`);`)
  await db.run(sql`CREATE TABLE \`_pages_v_blocks_technology_section\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`_path\` text NOT NULL,
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_technology_section_order_idx\` ON \`_pages_v_blocks_technology_section\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_technology_section_parent_id_idx\` ON \`_pages_v_blocks_technology_section\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_technology_section_path_idx\` ON \`_pages_v_blocks_technology_section\` (\`_path\`);`)
  await db.run(sql`CREATE INDEX \`_pages_v_blocks_technology_section_background_image_idx\` ON \`_pages_v_blocks_technology_section\` (\`background_image_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`header_secondary_nav_items\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`link_type\` text DEFAULT 'reference',
  ...
  `)
  await db.run(sql`CREATE INDEX \`header_secondary_nav_items_order_idx\` ON \`header_secondary_nav_items\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`header_secondary_nav_items_parent_id_idx\` ON \`header_secondary_nav_items\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`site_settings_social_media_platforms\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`site_settings_social_media_platforms_order_idx\` ON \`site_settings_social_media_platforms\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`site_settings_social_media_platforms_parent_id_idx\` ON \`site_settings_social_media_platforms\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`site_settings\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`branding_logo_id\` integer,
  	\`branding_logo_alt\` text DEFAULT 'Site Logo',
  	\`branding_favicon_id\` integer,
  	\`contact_email\` text DEFAULT 'karwacki.mikolaj123@gmail.com',
  	\`contact_phone\` text DEFAULT '+48 724 798 688',
  	\`contact_location\` text DEFAULT 'Poznań, Poland',
  	\`contact_timezone\` text DEFAULT 'Poznań (GMT + 01:00)',
  	\`analytics_google_analytics_id\` text,
  	\`analytics_google_tag_manager_id\` text,
  	\`analytics_facebook_pixel_id\` text,
  	\`maintenance_is_maintenance_mode\` integer DEFAULT false,
  	\`maintenance_maintenance_message\` text DEFAULT 'We are currently updating our website. Please check back soon!',
  	\`updated_at\` text,
  	\`created_at\` text,
  	FOREIGN KEY (\`branding_logo_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`branding_favicon_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null
  );
  `)
  await db.run(sql`CREATE INDEX \`site_settings_branding_branding_logo_idx\` ON \`site_settings\` (\`branding_logo_id\`);`)
  await db.run(sql`CREATE INDEX \`site_settings_branding_branding_favicon_idx\` ON \`site_settings\` (\`branding_favicon_id\`);`)
}

export async function down({ db }: MigrateDownArgs): Promise<void> {
  await db.run(sql`DROP TABLE \`pages_blocks_hero_section_cta_buttons\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_hero_section\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_about_me_section_stats\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_about_me_section\`;`)
  await db.run(sql`DROP TABLE \`pages_blocks_technology_section\`;`)
  ...
  await db.run(sql`DROP TABLE \`_pages_v_blocks_hero_section_cta_buttons\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_hero_section\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_about_me_section_stats\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_about_me_section\`;`)
  await db.run(sql`DROP TABLE \`_pages_v_blocks_technology_section\`;`)
  ...
  await db.run(sql`DROP TABLE \`header_secondary_nav_items\`;`)
  ...
  await db.run(sql`DROP TABLE \`site_settings_social_media_platforms\`;`)
